...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core Android EditText control.
/// </summary>
public class EditText : AndroidElementWrapper
{
    ...
    /// </summary>
    /// <param name="element">The <see cref="AppiumElement"/> representing the <see cref="EditText"/> element.</param>
    public EditText(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new EditText(element as AppiumElement);
    }
