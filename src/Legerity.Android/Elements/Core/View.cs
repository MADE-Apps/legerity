...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core Android View base control.
/// </summary>
public class View : AndroidElementWrapper
{
    ...
    /// </param>
    public View(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new View(element as AppiumElement);
    }
}