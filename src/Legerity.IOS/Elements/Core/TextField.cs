...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core iOS TextField control.
/// </summary>
public class TextField : IOSElementWrapper
{
    ...
    /// </summary>
    /// <param name="element">The <see cref="AppiumElement"/> representing the <see cref="TextField"/> element.</param>
    public TextField(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new TextField(element as AppiumElement);
    }
