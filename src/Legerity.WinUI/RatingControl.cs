...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the WinUI Rating control.
/// </summary>
public class RatingControl : WindowsElementWrapper
{
    ...
    /// </param>
    public RatingControl(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new RatingControl(element as AppiumElement);
    }
