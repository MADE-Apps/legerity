...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core UWP HyperlinkButton control.
/// </summary>
public class HyperlinkButton : Button
{
    ...
    /// </param>
    public HyperlinkButton(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new HyperlinkButton(element as AppiumElement);
    }
}