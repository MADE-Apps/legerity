...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core UWP TextBlock control.
/// </summary>
public class TextBlock : WindowsElementWrapper
{
    ...
    /// </param>
    public TextBlock(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new TextBlock(element as AppiumElement);
    }
}