...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core UWP PasswordBox control.
/// </summary>
public class PasswordBox : TextBox
{
    ...
    /// </param>
    public PasswordBox(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new PasswordBox(element as AppiumElement);
    }
