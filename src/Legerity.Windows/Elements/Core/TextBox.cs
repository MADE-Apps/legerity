...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core UWP TextBox control.
/// </summary>
public class TextBox : WindowsElementWrapper
{
    ...
    /// </param>
    public TextBox(AppiumElement element)
        : base(element)
    {
    }
    ...
    {
        return new TextBox(element as AppiumElement);
    }
