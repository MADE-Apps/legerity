...
/// <summary>
/// Defines a <see cref="AppiumElement"/> wrapper for the core UWP ListBox control.
/// </summary>
public class ListBox : WindowsElementWrapper
{
    ...
    /// </param>
    public ListBox(AppiumElement element)
        : base(element)
    {
    }
    ...
    /// </summary>
    public virtual ReadOnlyCollection<AppiumElement> Items => this.Element.FindElements(this.listBoxItemLocator);
    ...
    {
        return new ListBox(element as AppiumElement);
    }
