...
public abstract class BasePage
{
    ...
    {
        return this.App.FindElement(By.XPath(xpath)) as WebElement;
    }
    ...
    {
        return this.App.FindElements(By.XPath(xpath)).Cast<WebElement>().ToList().AsReadOnly();
    }
    ...
    {
        return this.App.FindElement(By.Id(id)) as WebElement;
    }
    ...
    {
        return this.App.FindElement(By.Name(name)) as WebElement;
    }
